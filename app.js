...
function renderInvoiceSheet(inv){
  ...
  $("#invoice-print-area").innerHTML = `
    ...
    <div class="inv-payment-info">
      ...
      <p>Please include Invoice Number "${inv.number}" as the payment reference.</p>
      <p><strong>Account Name:</strong> ${COMPANY.paymentAccountName}</p>
      <p><strong>Account Number:</strong> ${COMPANY.paymentNumber}</p>
      <p><strong>Payment Type:</strong> ${COMPANY.paymentType}</p>
    </div>
