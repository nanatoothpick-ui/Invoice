  ...
  $("#invoice-print-area").innerHTML = `
    ...
    <div class="inv-summary-row">
      <div class="inv-payment-info">
        ...
        <p>Please include Invoice Number <strong>${inv.number}</strong> as the payment reference.</p>
        <p>Account Name: ${COMPANY.paymentAccountName}</p>
        <p>Account Number: ${COMPANY.paymentNumber}</p>
        <p>Payment Type: ${COMPANY.paymentType}</p>
      </div>
