...
const COLUMNS = [
  ...
  "paidDate", "receiptNumber", "itemsJson"
];
...
function getSheet() {
  ...
  // Self-heal: if this sheet was created by an older version of this
  // script, add any new columns (like receiptNumber) it's missing,
